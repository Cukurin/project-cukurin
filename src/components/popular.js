...
class Popular extends React.Component {
  ...
  render() {
    ...
    let list = shops.slice(0, 4).map((shop, index) => {
      return (
        <Card
        ...
        >
          ...
          <CardBody>
            ...
            <CardText>{shop.phoneNumber}</CardText>
          </CardBody>
          <Button
            onClick={() => this.handleMove(shop._id, this.props.history)}
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-auto mr-auto">
              <CardGroup className="containerCardPopular">{list}</CardGroup>
            </div>
          </div>
        </div>
      </div>
